...
решила и о чём вспомнила. Покрытие — 85 unit-тестов плюс корпус из 77 кейсов
на обходы и ложные срабатывания.
...
3. **Замки** — 85 кейсов: JSON на вход, решение `allow/deny/ask` на выход.
   ...
   промолчать.
4. **Обходы и ложные срабатывания** — корпус из 77 кейсов
