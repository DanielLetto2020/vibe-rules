...
8. **Храповик долга** — 17 кейсов: первый прогон фиксирует факт, рост валит
   ...
   как «долга нет».
9. **Политика стека** — 20 кейсов, в том числе: проект вне политики сохраняет
   замки безопасности, а проект без файла политики не трогается вовсе.
10. **Правила уровня проекта** — 26 кейсов: шаблон, файл приоритета, запись
    отступления и разделение на коммитимые правила проекта и симлинки общих.
11. **Публикация** — 24 кейса, в том числе: релиз не создаётся, пока прогон
    на GitHub не зелёный.
12. **`claude plugin validate --strict`** по каждому модулю.
