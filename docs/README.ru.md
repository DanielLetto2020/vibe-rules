...
| Мой проект — легаси, с чего начать? | [примеры, сценарий 3](EXAMPLES.ru.md) |
| Общее правило мешает моему проекту | [как написать правило → что делать](WRITING-RULES.ru.md#что-делать-если-общее-правило-не-подходит-проекту) |
