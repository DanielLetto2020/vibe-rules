...
> 🇬🇧 [English version](CUSTOMIZATION.md) · [все документы](README.ru.md)
...
Подробности — [Храповик](RATCHET.ru.md) и [Профили](PROFILES.ru.md).
...
правило в хуке — гарантия.

Как формулировать — [Как написать своё правило](WRITING-RULES.ru.md).

---

## Дальше

- [Легаси и переписывание](LEGACY.ru.md) — правила для переходного периода
- [Как написать своё правило](WRITING-RULES.ru.md) — формулировки и ошибки
- [Примеры](EXAMPLES.ru.md), сценарий 5 — своё правило от начала до конца
