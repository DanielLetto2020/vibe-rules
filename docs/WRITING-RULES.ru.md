...
Правило с `lint`, но без конфига линтера — самообман: выглядит как проверка,
работает как просьба.
...
- [Основы простыми словами](START.ru.md)
- [Профили](PROFILES.ru.md) — где настраивается строгость проверок
- [Примеры](EXAMPLES.ru.md) — пятый сценарий про своё правило
- [Правило или замок](ENFORCEMENT.md) — подробнее про границу
- [Как добавить модуль](../CONTRIBUTING.md) — если нужен целый новый стек
