...
> 🇬🇧 [English version](LEGACY.md) · [все документы](README.ru.md)
...
Подробно — [Профили](PROFILES.ru.md), [Храповик](RATCHET.ru.md).
...
- [Свои правила в проекте](CUSTOMIZATION.ru.md) — где живут правила проекта
- [Храповик](RATCHET.ru.md) — как работает планка и как её двигать
- [Примеры](EXAMPLES.ru.md), сценарий 3 — старый код без тестов, по шагам
