...
- [Как написать своё правило](WRITING-RULES.ru.md) — по шагам, с примерами
- [Профили](PROFILES.ru.md) — где живут, как выбрать и настроить под себя
- [Примеры](EXAMPLES.ru.md) — пять сквозных сценариев: подключение,
  новая функция, старый код, удаление, своё правило
- [Устройство](ARCHITECTURE.md) — почему сделано именно так
- [Правило или замок](ENFORCEMENT.md) — как решить, куда положить требование
